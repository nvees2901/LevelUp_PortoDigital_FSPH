    ...
    <div className="bg-white rounded-xl border border-slate-200 shadow-sm flex flex-col">
      <div className="p-4 border-b border-slate-200 flex flex-wrap gap-3 justify-between items-center">
        ...
        {usuario?.id === 'demandante' && (
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 text-sm font-bold text-white rounded-lg shadow-sm bg-brand-primary hover:bg-brand-hover transition"
          >
      ...
      {loading ? (
        ...
        <div className="p-10 text-center">
          ...
          <button
            onClick={fetchTerms}
            className="px-4 py-2 text-sm font-bold text-white rounded-lg bg-brand-primary"
          >
            Tentar novamente
          </button>
        </div>
            ...
            <tbody className="divide-y divide-slate-100">
              {lista.map(term => (
                <tr key={term.id} className="hover:bg-slate-50 transition-colors">
                  <td className="p-4">
                    <p className="font-bold text-brand-primary text-sm font-mono">
                      {term.id.slice(0, 8)}...
                    </p>
                  ...
                  <td className="p-4 text-right">
                    <button
                      ...
                      className="text-brand-primary hover:bg-blue-50 font-bold text-xs px-3 py-1.5 rounded transition-colors border border-transparent hover:border-blue-200"
                    >
                      Ver Detalhes
                    </button>
                  </td>
